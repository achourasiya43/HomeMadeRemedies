package com.demo.template.providers.woocommerce;
...
import com.demo.template.providers.woocommerce.interceptor.OAuthInterceptor;
import com.demo.template.providers.woocommerce.model.RestAPI;
import com.demo.template.providers.woocommerce.model.orders.Order;
...
import com.demo.template.providers.woocommerce.model.users.User;
import com.demo.template.providers.woocommerce.ui.WooCommerceDebugDialog;
        ...
        for (int i = 0; i < Jobject.length(); i++) {
            try {
                if (type.equals(Product.class)) {
                    ...
                    if (!product.getPurchasable() && product.getExternalUrl() == null) continue;
